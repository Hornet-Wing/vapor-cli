...
class EnvPushCommand extends Command
{
    ...
    protected function configure()
    {
        $this
            ...
            ->addOption('preserve', 'p', InputOption::VALUE_NONE, "Don't delete after push");
    }
    ...
    public function handle()
    {
        ...
        if (!$this->option('preserve') && Helpers::confirm('Would you like to delete the environment file from your machine')) {
            @unlink($file);
        }
    }
}
